...
O presente estudo enfoca a utilização de ontologias para recuperação de 
informações jurídicas contidas nos acórdãos do STF. Serão também empregadas 
tecnologias como SPARQL que possibilita a realização de consultas e OBDA que
permite a criação de uma camada semântica em uma base de dados relacional.
\\
