...
\noindent BRITO DE OLIVEIEA, RAFAEL. \textbf{Utilização de Ontologias para Busca 
...
velocidade que cresce, surgiram tecnologias como a Web Semântica visando dar aos
computadores a possibilidade de não somente apresentar a informação, mas também
de poder interpretá-la.
